                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>BARANG</h3>
                                    <form action="<?php echo base_url('backend/Admin/do_insert') ?>" method="POST" enctype="multipart/form-data">
                                    <form role="form">
                                        
                                        
                                        <div class="form-group">
                                            <label>Nama Barang</label>
                                            <input name="produk_nama" class="form-control" />
                                        ...
                                        <div class="form-group">
                                           <label>Harga Barang</label>
                                            <input name="produk_harga" class="form-control" />
