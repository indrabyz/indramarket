                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>KATEGORI BUKU</h3>
                                    <form action="<?php echo base_url('backend/C_kategori/do_update') ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                           <label>Nama Kategori</label>
                                            ...
                                            <input name="nama_kategori" class="form-control"  value="<?php echo $nama_kategori; ?>" />
