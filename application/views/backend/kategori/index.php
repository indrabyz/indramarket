                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                 <a href="<?php echo base_url('backend/C_kategori/add')?>"><button class="btn btn-success" style="margin-bottom: 10px;">TAMBAH</button></a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td align="center">
                                                <a href="<?php echo base_url()."backend/C_kategori/do_edit/".$d['id']; ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-edit "></i> Edit</button>
                                                <a href="<?php echo base_url()."backend/C_kategori/do_delete/".$d['id']; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> Delete</button>
                                            </td>
                                        </tr>
                                        <?php 
                                            $nomor = $nomor+1; } ?>
